package uz.beta.educationcenterdemo1.utils;

import org.springframework.data.domain.PageRequest;
import org.springframework.data.domain.Pageable;
import org.springframework.data.domain.Sort;
import uz.beta.educationcenterdemo1.exception.BadRequestException;
...
public class CommonUtils {
    ...
    public static Pageable getPageableByRankDesc(int page, int size) {
        validatePageNumberAndSize(page, size);
        return PageRequest.of(page, size,Sort.Direction.DESC,"rank");
    }
    public static Pageable getPageableBySubjectPriceAsc(int page, int size) {
        validatePageNumberAndSize(page, size);
